...
namespace Richi
{
    ...
    {
        public static IEnumerator ZoomIn(RectTransform Transform, float Speed, Action OnEnd)
        {
            float time = 0;
            while (time < 1)
            {
        ...
        public static IEnumerator ZoomOut(RectTransform Transform, float Speed, Action OnEnd)
        {
            float time = 0;
            while (time < 1)
            {
        ...
        public static IEnumerator FadeIn(CanvasGroup CanvasGroup, float Speed, Action OnEnd)
        {
        ...
        public static IEnumerator FadeOut(CanvasGroup CanvasGroup, float Speed, Action OnEnd)
        {
        ...
        public static IEnumerator SlideIn(RectTransform Transform, Direction Direction, float Speed, Action OnEnd)
        {
        ...
        public static IEnumerator SlideOut(RectTransform Transform, Direction Direction, float Speed, Action OnEnd)
        {
            Vector2 endPosition;
            switch (Direction)
            {
