...
public class CreateQuestDatabase : SingletonMonoBehaviour<CreateQuestDatabase>
{
   ...
   // public List<Quest> quests = new List<Quest>();
    ...
    {
        UnityWebRequest www = UnityWebRequest.Get("https://checkiapp.com/get_quests.php?id=" + id);
    ...
    public IEnumerator SendDataCoroutine(Quest Data, Action<bool> onSuccess)
    {
        ...
        UnityWebRequest www = UnityWebRequest.Post("https://checkiapp.com/create_quest.php", form);
        yield return www.SendWebRequest();
    ...
    IEnumerator DeleteDataCoroutine(int id, Action<bool> onSuccess)
    {
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://checkiapp.com/delete_quest.php", form))
        {
            yield return www.SendWebRequest();
    ...
    IEnumerator UpdateDataCoroutine(Quest data, Action<bool> onSuccess)
    {
        ...
        UnityWebRequest www = UnityWebRequest.Post("https://checkiapp.com/update_quest.php", form);
        yield return www.SendWebRequest();
